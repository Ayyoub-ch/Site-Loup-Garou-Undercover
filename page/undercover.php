<title>Score à l'Undercover</title>
<?php
...
";
$joueurs = $pdo->query($sql_undercover)->fetchAll(PDO::FETCH_ASSOC);
?>

<main class="content">
    <h1>Scores au jeu de l'Undercover</h1>
    ...
    <div class="center-images">
        <div class="player">
            ...
            <div class="score-name">
                <h1><?= htmlspecialchars($joueurs[0]['victoire_undercover'] ?? 0) ?></h1>
        ...
        <div class="player">
            ...
            <div class="score-name">
                <h1><?= htmlspecialchars($joueurs[1]['victoire_undercover'] ?? 0) ?></h1>
